    ...
    <div class="w-full max-w-md">
        ...
        <div class="rounded-2xl p-8" style="background:var(--color-brand-surface); border:1px solid var(--color-brand-border)">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-sm" style="color:var(--color-brand-muted)">Sign in to your Ticko-Plug account</p>
            </div>
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <span class="text-xs" style="color:var(--color-brand-subtle)">or sign in with email</span>
                <div class="flex-1 h-px" style="background:var(--color-brand-border)"></div>
            </div>
            ...
            <form method="POST" action="{{ route('login.post') }}" class="space-y-5">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1.5">
                        ...
                        <a href="#" class="text-xs" style="color:var(--color-brand-primary)">Forgot password?</a>
                    </div>
                ...
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="remember" class="rounded" style="accent-color:var(--color-brand-primary)">
                    <span class="text-sm" style="color:var(--color-brand-muted)">Remember me</span>
                </label>
            ...
            <p class="text-center text-sm mt-6" style="color:var(--color-brand-muted)">
                ...
                <a href="{{ route('register') }}" style="color:var(--color-brand-primary)" class="font-medium hover:underline">Create one</a>
            </p>
        </div>
